# Base de Referências — Tributário

Cada matéria tributária tem sua própria subpasta aqui (ex.:
`execucao-fiscal/`, `restituicao-ir/`, `ppp-e-parcelamentos/`), criada sob
demanda na primeira vez que o escritório trabalha aquela matéria. Não crie
subpastas antecipadamente para matérias que ainda não surgiram em nenhum
caso.
...
Essa pasta é usada pela skill `pecas-previdenciarias-escritorio` — ver a
seção "BASE DE REFERÊNCIAS DO ESCRITÓRIO" nela para o fluxo completo de
