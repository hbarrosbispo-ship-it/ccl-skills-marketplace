...
em `calibragem-densidade.md` (patamar leve) e nas demais seções do SKILL.md.
...
- A OAB do(s) advogado(s) subscritor(es) é sempre obrigatória em
  requerimentos e recursos administrativos (ver
...
- Limite de tamanho de arquivo para protocolo no INSS: 5 MB por documento,
  30 MB no total somando todos os arquivos do protocolo (ver
  `protocolo.md`).
- Como regra geral, não inclua CNIS, comprovante de residência ou CadÚnico
  ...
  nessa fase (ver nota em `protocolo.md`). Inclua apenas se o caso concreto
  exigir expressamente ou o usuário solicitar.
...
- Não cite jurisprudência no âmbito administrativo (reforça RESTRIÇÕES
  ABSOLUTAS e ETAPA 7 do SKILL.md); fundamente exclusivamente em Instruções
  Normativas, Portarias, Decretos e demais atos normativos do órgão.
- **Vigência do Regimento Interno do CRPS.** Antes de citar ou fundamentar
  algo no Regimento Interno do CRPS, confirme sua vigência conforme a regra
  de citação de fontes (`referencias-escritorio/regras-comuns/citacao-fontes.md`)
  como para qualquer outro ato normativo — se houver dúvida concreta sobre
